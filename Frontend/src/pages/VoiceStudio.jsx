...
const VoiceStudio = () => {
  ...
  const handleDownload = async (session) => {
    ...
    if (audioBlob && audioBlob.data instanceof Blob) {
      ...
      a.href = url;
      a.download =
        session.audio_file?.filename || `echoverse-${session.id}.mp3`;
          ...
          <div className="flex items-center space-x-2">
            <div className="flex items-center space-x-1">
              <button
                onClick={() =>
                  handlePlaybackRateChange(
                    playbackRate === 0.5 ? 1.0 : playbackRate - 0.25,
                  )
                }
              ...
              <button
                onClick={() =>
                  handlePlaybackRateChange(
                    playbackRate === 2.0 ? 2.0 : playbackRate + 0.25,
                  )
                }
                className="text-xs text-gray-600 hover:text-gray-900"
              >
    ...
    <div className="mt-8 min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8 px-4 sm:px-6 lg:px-8">
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="mb-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="hidden text-3xl font-bold text-gray-900">
                Voice Studio
              </h1>
        ...
        <div
          id="v-wrapper"
          className="absolute left-0 top-0 h-fit z-[1] w-fit mb-2"
        >
              ...
              <div className="flex items-center justify-between bg-white rounded-xl border border-gray-200 px-6 py-4">
                ...
                <div className="flex space-x-2">
                  <button
                    ...
                    className="px-3 py-2 border border-gray-300 text-gray-800 rounded-lg text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    Previous
                  </button>
                  ...
                  <button
                    ...
                    className="px-3 py-2 border text-gray-800 border-gray-300 rounded-lg text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    Next
                  </button>
                </div>
